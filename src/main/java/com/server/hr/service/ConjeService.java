...
public class ConjeService {
    ...
    public Leave findcongeEmployee(Long id_e) {
    	return conjeRepo.findCongeEmployeeById(id_e).orElseThrow(()-> new CongeEmployeeNotFoundExcep("leave of employee "+id_e+" not found"));
    }
